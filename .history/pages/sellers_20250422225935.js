import styles from '../styles/Sellersrvices.module.css';
...
export default function Services() {
  return (
    <div className={styles.container}>
      <Head>
        <title>Working with Buyers/Sellers | MacGillivray Property Lawyers</title>
      ...
      <main className={styles.main}>
        <div className={styles.header}>
          <h1 className={styles.title}>
            <span className={styles.smallTitle}>Buyers /</span>
